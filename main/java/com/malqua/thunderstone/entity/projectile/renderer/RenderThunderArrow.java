package com.malqua.thunderstone.entity.projectile.renderer;
 ...
 */
public class RenderThunderArrow extends Render<EntityThunderArrow> {

    public RenderThunderArrow(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    @Override
    public void doRender(EntityThunderArrow entity, double x, double y, double z, float entityYaw, float partialTicks) {
//        super.doRender(entity, x, y, z, entityYaw, partialTicks);
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(ThunderstoneMod.TEXTURE_PATH+"entity/thunder_arrow.png");

    @Override
    protected ResourceLocation getEntityTexture(EntityThunderArrow entity) {
        return TEXTURE;
    }
}
